...
public class Termin implements Serializable {
    ...
    @ManyToOne
    @NotNull(message = "Die Termin muss einem Benutzer geordnet werden.")
    private User owner;
    ...
    public Termin(User owner, Category category, String shortText, String longText, Date dueDate, Time dueTime) {
        this.owner = owner;
