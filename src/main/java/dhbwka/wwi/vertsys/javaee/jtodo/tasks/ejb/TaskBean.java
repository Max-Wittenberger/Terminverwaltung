...
public class TaskBean extends EntityBean<Termin, Long> { 
     ...
     */
    public List<Termin> findByUsername(String username) {
     ...
     */
    public List<Termin> search(String search, Category category, TaskStatus status) {
        // Hilfsobjekt zum Bauen des Query
        CriteriaBuilder cb = this.em.getCriteriaBuilder();
        
        // SELECT t FROM Termin t
        CriteriaQuery<Termin> query = cb.createQuery(Termin.class);
        Root<Termin> from = query.from(Termin.class);
        query.select(from);
